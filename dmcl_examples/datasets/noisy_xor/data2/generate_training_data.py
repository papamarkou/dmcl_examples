...
from dmcl_examples.datasets.noisy_xor import simulate_xor
from dmcl_examples.datasets.noisy_xor.data2.constants import num_training_samples, training_data_path
