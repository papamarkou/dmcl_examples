...
from dmcl_examples.experiments.mlp.noisy_xor.setting13.mcmc.batch_sampler import BatchSampler
from dmcl_examples.experiments.mlp.noisy_xor.setting13.mcmc.constants import batch_size, shuffle
