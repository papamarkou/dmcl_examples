...
from dmcl_examples.experiments.mlp.mnist.setting6.mcmc.constants import num_chains
from dmcl_examples.experiments.mlp.mnist.setting6.mcmc.constants import diagnostic_iter_thres
