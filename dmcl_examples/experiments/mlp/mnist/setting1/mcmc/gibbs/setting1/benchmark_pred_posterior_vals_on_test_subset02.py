...
from dmcl_examples.experiments.mlp.mnist.setting1.mcmc.datascanners import test_dataloader_subset02
from dmcl_examples.experiments.mlp.mnist.setting1.mcmc.gibbs.constants import sampler_output_run_paths
from dmcl_examples.experiments.mlp.mnist.setting1.mcmc.gibbs.setting1.constants import (
...
for k in range(num_chains):
    ...
    np.savetxt(summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset02.csv'), test_pred_probs, delimiter=',')
    np.savetxt(
        summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset02_num_dropped_samples.csv'),
