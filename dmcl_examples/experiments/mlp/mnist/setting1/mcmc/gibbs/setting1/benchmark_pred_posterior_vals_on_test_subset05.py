...
from dmcl_examples.experiments.mlp.mnist.setting1.mcmc.datascanners import test_dataloader_subset05
...
for k in range(num_chains):
    ...
    np.savetxt(summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset05.csv'), test_pred_probs, delimiter=',')
    np.savetxt(
        summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset05_num_dropped_samples.csv'),
