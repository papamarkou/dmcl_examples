...
from dmcl_examples.experiments.mlp.mnist.setting4.mcmc.constants import diagnostic_iter_thres
from dmcl_examples.experiments.mlp.mnist.setting4.mcmc.gibbs.constants import sampler_output_pilot_path
