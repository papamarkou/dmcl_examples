...
from dmcl_examples.experiments.mlp.fashion_mnist.setting5.constants import dtype
from dmcl_examples.experiments.mlp.fashion_mnist.setting5.model import hparams, prior_scale
