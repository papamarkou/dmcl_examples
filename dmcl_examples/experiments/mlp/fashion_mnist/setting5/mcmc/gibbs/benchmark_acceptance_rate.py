...
from dmcl_examples.experiments.mlp.fashion_mnist.setting5.mcmc.constants import num_chains
from dmcl_examples.experiments.mlp.fashion_mnist.setting5.mcmc.constants import diagnostic_iter_thres
