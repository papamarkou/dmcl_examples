...
from dmcl_examples.experiments.mlp.fashion_mnist.setting4.mcmc.datascanners import test_dataloader_subset04
...
for k in range(num_chains):
    ...
    np.savetxt(sampler_output_run_paths[k].joinpath('pred_posterior_on_test_subset04.csv'), test_pred_probs, delimiter=',')
    np.savetxt(
        sampler_output_run_paths[k].joinpath('pred_posterior_on_test_subset04_num_dropped_samples.csv'),
