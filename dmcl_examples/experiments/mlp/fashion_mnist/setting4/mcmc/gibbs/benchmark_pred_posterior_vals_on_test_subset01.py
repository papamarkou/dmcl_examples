...
from dmcl_examples.experiments.mlp.fashion_mnist.setting4.mcmc.datascanners import test_dataloader_subset01
...
for k in range(num_chains):
    ...
    np.savetxt(sampler_output_run_paths[k].joinpath('pred_posterior_on_test_subset01.csv'), test_pred_probs, delimiter=',')
    np.savetxt(
        sampler_output_run_paths[k].joinpath('pred_posterior_on_test_subset01_num_dropped_samples.csv'),
