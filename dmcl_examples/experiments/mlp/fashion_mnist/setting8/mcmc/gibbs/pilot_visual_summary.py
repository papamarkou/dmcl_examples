...
from dmcl_examples.experiments.mlp.fashion_mnist.setting8.mcmc.constants import diagnostic_iter_thres
from dmcl_examples.experiments.mlp.fashion_mnist.setting8.mcmc.gibbs.constants import sampler_output_pilot_path
