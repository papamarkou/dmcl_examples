...
from dmcl_examples.experiments.mlp.fashion_mnist.setting6.mcmc.constants import batch_size
from dmcl_examples.experiments.mlp.fashion_mnist.setting6.mcmc.load_datasets import (
