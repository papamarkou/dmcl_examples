...
for k in range(num_chains):
    ...
    np.savetxt(summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset01.csv'), test_pred_probs, delimiter=',')
    np.savetxt(
        summary_output_run_paths[k].joinpath('pred_posterior_on_test_subset01_num_dropped_samples.csv'),
