...
from dmcl_examples.experiments.mlp.fashion_mnist.setting1.constants import output_path
from dmcl_examples.experiments.mlp.fashion_mnist.setting1.mcmc.constants import num_chains, num_epochs
