...
from dmcl_examples.experiments.mlp.fashion_mnist.setting1.constants import dtype

# %% Create training dataset

# https://discuss.pytorch.org/t/normalization-in-the-fashion_mnist-example/457/27
# https://discuss.pytorch.org/t/fashion_mnist-normalization/49080/2
# https://gist.github.com/kdubovikov/eb2a4c3ecadd5295f68c126542e59f0a

training_dataset = datasets.FashionMNIST(root=data_root, train=True, download=False, transform=None)
...
test_dataset = datasets.FashionMNIST(root=data_root, train=False, download=False)
